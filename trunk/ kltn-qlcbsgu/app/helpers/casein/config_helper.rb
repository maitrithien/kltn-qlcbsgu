module Casein
  module ConfigHelper
    ...
    def casein_config_website_name
    	"#{Param.get_param_value("website_name")}"
    end
    ...
    def casein_config_hostname
  	...
  	def casein_config_javascript_includes
  	  %w[/casein/javascripts/jquery /casein/javascripts/showhide /casein/javascripts/custom /casein/javascripts/casein /casein/javascripts/rails]
  	end
